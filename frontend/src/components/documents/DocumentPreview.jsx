    ...
    <div className="flex flex-col gap-6">
      <header className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button type="button" className="rounded-full border border-slate-200 px-3 py-1 text-sm text-slate-500" onClick={onClose}>
            Close
          </button>
        </div>
      </header>
      <div className="grid gap-3 text-sm text-slate-600">
        <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50/80 p-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">{document.size} · .{document.extension}</p>
          </div>
        </div>
      ...
      <footer className="flex items-center justify-between border-t border-slate-100 pt-4">
        ...
        <div className="flex gap-2">
          ...
          <button type="button" className="rounded-xl border border-slate-200 px-3 py-2 text-sm text-slate-600" onClick={onDownload}>
            Download
          </button>
